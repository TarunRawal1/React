...
import { createOrders } from "../../Service/Dataservice";
export const Checkout = ({ setcheckout }) => {
  ...
  async function handleorder(e) {
    ...
    try {
      const data = await createOrders(cart, total, user);
      dispatch(clearCart());
      navigate("/order-summary", { state: { data: data, success: true } });
    } catch (err) {
      navigate("/order-summary", { state: { data: err, success: false } });
    }
  }
